...
# Esse script faz referência ao (3.1) Script CVM usado na aula III. 




#%%                                     AULA 3 DATA WRANGLING PARTE 2 - LINHA 8 a 169
...
# Inserir o objeto "data" no objeto "dados_sel", na coluna 5, chamando de ANO
...
# Criar uma variável com o valor defasado. Shift leva o valor da conta de 2021 ao lado de 2022 referenciando CVM E CONTA.
